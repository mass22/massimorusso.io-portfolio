      ...
      <div class="flex flex-col gap-6 md:gap-8">
        ...
        >
          <NuxtLink
            ...
            class="group relative block rounded-2xl border border-default/20 bg-elevated/50 dark:bg-elevated/30 backdrop-blur-sm px-8 py-8 md:px-10 md:py-10 transition-all duration-500 ease-out overflow-hidden cursor-pointer hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1 focus-within:border-primary/30 focus-within:shadow-xl focus-within:shadow-primary/5 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:ring-offset-2 focus:ring-offset-background"
          >
            ...
            <div class="relative flex flex-col md:flex-row items-stretch min-h-[200px] z-10">
              ...
              <div class="flex flex-col gap-4 md:max-w-[calc(100%-400px)]">
                ...
                <div class="mt-4">
                  <span
                    class="inline-flex items-center gap-2 text-sm font-semibold text-primary/80 group-hover:text-primary transition-colors duration-300"
                  >
                    {{ linkLabelText }}
                    <UIcon
          ...
          <div
            v-else
            :aria-label="item.title"
            class="group relative block rounded-2xl border border-default/20 bg-elevated/50 dark:bg-elevated/30 backdrop-blur-sm px-8 py-8 md:px-10 md:py-10 transition-all duration-500 ease-out overflow-hidden cursor-default"
          >
            <!-- Right: Image Preview (Desktop only, hover reveal) - Positioned relative to parent -->
            <div
              v-if="getItemImage(item)"
            ...
            <div class="relative flex flex-col md:flex-row items-stretch min-h-[200px] z-10">
              ...
              <div class="flex flex-col gap-4 md:max-w-[calc(100%-400px)]">
                ...
                <div class="mt-4">
                  <span
                    class="inline-flex items-center gap-2 text-sm font-semibold text-primary/80 group-hover:text-primary transition-colors duration-300 cursor-default opacity-50"
                  >
                    {{ linkLabelText }}
                    <UIcon
                      name="i-lucide-arrow-right"
